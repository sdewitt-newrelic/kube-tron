...
{{ include "fulfillment.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "fulfillment.selectorLabels" -}}
...
*/}}
{{- define "fulfillment.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "fulfillment.fullname" .) .Values.serviceAccount.name }}
{{- else }}
